...
import {
  fetchSaveInfoAboutUs,
  fetchGetInfoAboutUs,
} from "../../redux/slices/aboutSlice/fetchService";
        ...
        <>
          <Container>
            ...
            >
              <TapsForChangeTextComponent
                handleChangeProjectData={handleChangeAboutPageData}
                tabDataForMap={textsDataForTabs}
                dataForChange={aboutPageData.aboutData as object}
              />
            </Box>
            <Box
              sx={{
            ...
            >
              <TapsForChangeImagesComponent
                tabDataForMap={imagesDataForTabs}
                dataForChange={aboutPageData.aboutData}
                onChangeImageInObject={handleChangeAboutPageData}
              />
            </Box>
          </Container>
          ...
          >
            <Button
              ...
              color="success"
              fullWidth
              onClick={saveAboutUsDataHandler}
            >
              Պահպանեք տվյալները
            </Button>
          </Box>
