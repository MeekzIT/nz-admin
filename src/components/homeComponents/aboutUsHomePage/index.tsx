...
import { fetchEditAboutUsShortData, fetchGetAboutShortData } from '../../../redux/slices/homeAboutSlice/fetchService'
...
import { aboutUsShortDataKeysForTabText, aboutUsShortImageDataKeysForTabText } from './constants'
...
const AboutUsHome = () => {
  ...
  const { currentAboutUsData, loading } = useAppSelector((state) => state.homeAbout)
      ...
      {currentAboutUsData &&
        <Container>
          ...
          <BlockWithBackgroundBlend>
            ...
            <TapsForChangeImagesComponent tabDataForMap={aboutUsShortImageDataKeysForTabText} dataForChange={currentAboutUsData!} onChangeImageInObject={handleChangeTextFildsAboutUsShort} />
          </BlockWithBackgroundBlend>
